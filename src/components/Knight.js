...
const Knight = ({ knightColor, faceColor, stripeColor }) => {
  return (
    <CenterChessPiece>
      ...
      <KnightEarRight bgcolor={knightColor} marginTop="0.5" marginLeft="-0.75"/>
      <KnightBack bgcolor={knightColor} marginTop="2.5" marginLeft="3" />
      <KnightBody bgcolor={knightColor} marginTop="4" marginLeft="3" />
      <KnightBackStripe  bgcolor={knightColor} borderColor={stripeColor} marginTop="1" marginLeft="0.85"/>
